...
/// @param {Real|Array<Real>} ... One or more real values or arrays of real values.
...
/// @param {Array|Real} ... One or more real values or arrays of real values.
/// @returns {Real}
/// @pure
function sum()
{
...
/// @desc Wraps n within the range _min to _max, looping around when the value exceeds either bound. Returns undefined if _min and _max are equal.
/// @param {Real} n The value to wrap.
/// @param {Real} _min The lower bound of the range.
/// @param {Real} _max The upper bound of the range.
/// @returns {Real|Undefined}
/// @pure
